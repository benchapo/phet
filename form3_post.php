...
<head>
    ...
    <link href="https://cdn.jsdelivr.net/npm/docsearch.js@2/dist/cdn/docsearch.min.css" rel="stylesheet" integrity="sha384-EVSTQN3/azprG1Anm3QDgpJLIm9Nao0Yz1ztcQTwFspd3yD65VohhpuuCOmLASjC" crossorigin="anonymous">
    <title>Form</title>
    <style>
        body {
...
<body>
    <div class="container">
        ...
        <form class="row g-3" action="Insert.php">
            ...
            <div class="form-group">
                <label for="inputCity" class="form-label">เบอร์ติดต่อของผู้ส่ง</label>
            ...
            <div class="form-group">
                <label for="inputCity" class="form-label">เบอร์ติดต่อของผู้รับ</label>
            ...
            <div class="form-group">
                ...
                <select class="form-select" id="province" required onchange="updateDistricts()" name="jungwat">
                    ...
                    <option value="bangkok">เชียงใหม่</option>
                </select>
            </div>
            <div class="form-group">
                <label for="district" class="form-label">อำเภอ/เขต หรือที่อยู่</label>
