...
<html lang="en">
  ...
  <body class="p-3 m-0 border-0 bd-example m-0 border-0">
    <h1>ชื่อและที่อยู่ของผู้ส่ง</h1>
    <form class="row g-3 needs-validation was-validated" novalidate="" method="post" action="select.php">
      <div class="col-md-4">
        ...
        <div class="valid-feedback">
          Looks good! <title>Form Github</title>
        </div>
      </div>
      <div class="col-md-4">
      ...
      <div class="col-md-4">
        <label for="validationCustom02" class="form-label">ชื่อเล่น</label>
        <input type="text" class="form-control" id="validationCustom02"  required=""  name="La">
        <div class="valid-feedback">
          Looks good!
        </div>
      ...
      <div class="col-md-4">
        <label for="validationCustomUsername" class="form-label">บ้านเลขที่-ที่อยู่</label>
      ...
      <div class="col-md-3">
        <label for="validationCustom05" class="form-label">เบอร์โทรศัพท์</label>
      ...
      <div class="col-md-3">
        <label for="validationCustom05" class="form-label">วันที่-เดือน</label>
